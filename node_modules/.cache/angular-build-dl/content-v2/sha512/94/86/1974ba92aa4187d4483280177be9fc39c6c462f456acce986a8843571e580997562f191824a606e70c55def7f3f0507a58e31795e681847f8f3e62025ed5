...
/* harmony import */ var _ionic_native_background_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/background-geolocation/ngx */ "./node_modules/@ionic-native/background-geolocation/__ivy_ngcc__/ngx/index.js");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, backgroundGeolocation, localNotifications) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            this.backgroundGeolocation.configure(config).then(() => {
                this.backgroundGeolocation.on(_ionic_native_background_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__["BackgroundGeolocationEvents"].location)
                    .subscribe((location) => {
...
/* harmony import */ var _ionic_native_background_geolocation_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/background-geolocation/ngx */ "./node_modules/@ionic-native/background-geolocation/__ivy_ngcc__/ngx/index.js");
...
module.exports = __webpack_require__(/*! D:\Ionic Projects\Ionic3BackgroundGeolocation\src\main.ts */"./src/main.ts");
